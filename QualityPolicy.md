...
**GitHub Workflow** (due Feb 2nd)
  > Structure: We will have a master branch which will always be ready to ship as a product. We will have a dev branch which is our version we are working on and may break. We will have a branch for every user story and they will be named in the format "US#". We will have sub-branches for every task for the user stories named in the format "US#-T#".
